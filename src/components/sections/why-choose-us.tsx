    ...
    <section className="py-16 sm:py-20 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              <div key={index} className="text-center">
                <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
                  <div className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-emerald-100 text-emerald-600 rounded-lg sm:rounded-xl mb-3 sm:mb-4">
            ...
            return (
              <Card key={index} className="border-0 shadow-md hover:shadow-lg transition-shadow dark:bg-gray-800">
                <CardContent className="p-4 sm:p-6">
                  <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl ${benefit.color} flex items-center justify-center mb-3 sm:mb-4`}>
            ...
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="border-0 shadow-md dark:bg-gray-800">
                <CardContent className="p-4 sm:p-6">
                  ...
                  <blockquote className="text-sm sm:text-base text-gray-700 dark:text-gray-300 mb-3 sm:mb-4 italic">
                    &quot;{testimonial.text}&quot;
                  </blockquote>
                  <div>
                    <div className="font-semibold text-sm sm:text-base text-gray-900 dark:text-white">{testimonial.name}</div>
                    <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">{testimonial.location}</div>
        ...
        <div className="text-center mt-12 sm:mt-16">
          <div className="bg-gradient-to-r from-emerald-600 to-blue-600 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-white mx-2 sm:mx-0">
            <Globe className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-4 sm:mb-6 opacity-90" />
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2 sm:px-0">
              <button className="bg-white text-emerald-600 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-gray-50 transition-colors text-sm sm:text-base">
                Start Planning Today
              </button>
              <button className="border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-white/10 transition-colors text-sm sm:text-base">
                Download Brochure
              </button>
            </div>
          </div>
